...
//   void _setMaxLengthFromRewards() {
//     // Example reward value, replace this with actual widget.userBal[0]["rewards"]
//     String rewardValue = widget.userBal[0]["rewards"].toString();
//     String numericValueString = toCurrencyString(rewardValue);

//     // Extract the numeric value from the formatted string
//     int numericValue =
//         int.tryParse(numericValueString.replaceAll(',', '')) ?? 5;

//     // Ensure maxLength is valid
//     if (numericValue > 0) {
//       setState(() {
//         _maxLength = numericValue.toString().length;
//       });
//     }
//   }
...
//                                     ),
//                                     Container(height: 20),
//                                     LabelText(text: "Payment Details"),
//                                     Container(height: 10),
...
//                       CustomDisplayText(
//                         label: toCurrencyString(
//                                 widget.userBal[0]["user_bal"].toString())
//                             .toString(),
//                         fontSize: 16,
//                         fontWeight: FontWeight.bold,
//                         maxLines: 1,
...
//                       CustomDisplayText(
//                         label: toCurrencyString(
//                                 widget.userBal[0]["rewards"].toString())
//                             .toString(),
//                         fontSize: 16,
//                         fontWeight: FontWeight.bold,
//                         maxLines: 1,
...
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
//           CustomDisplayText(label: "Enter desired amount to be used"),
//           CustomTextField(
                              ...
                              if (!isHide)
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (vehicleText != "Tap to add vehicle")
                                      CustomDisplayText(
                                          label: "Tap below to use your points",
                                          color: Colors.grey,
                                          fontSize: 12,
                                          fontWeight: FontWeight.w600,
                                          letterSpacing: -0.41),
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                      CustomDisplayText(
                                                                    label: subtractedToken.toStringAsFixed(2) ==
                                                                            "0.00"
                                                                        ? toCurrencyString(
                                                                            totalAmount)
                                                                        : subtractedToken
