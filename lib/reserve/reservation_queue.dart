...
// class ReservationQueue extends StatefulWidget {
//   const ReservationQueue({super.key});

//   @override
//   State<ReservationQueue> createState() => _ReservationQueueState();
// }

// class _ReservationQueueState extends State<ReservationQueue> {
...
//                                                   isLoadingBtn = true;
//                                                 });
//                                                 Variables.hasInternetConnection(
//                                                     (hasNet) {
//                                                   if (hasNet) {
//                                                     setState(() {
//                                                       callBackData = cbData;
//                                                       vehicleText = callBackData[
//                                                               0]
//                                                           ["vehicle_plate_no"];
//                                                     });
//                                                     routeToComputation();
...
//                                               "client_id": widget.areaData[0]
//                                                   ["client_id"],
//                                               "park_area_id": widget.areaData[0]
//                                                   ["park_area_id"],
//                                               "vehicle_plate_no":
//                                                   callBackData[0]
//                                                       ["vehicle_plate_no"],
//                                               "vehicle_type_id": callBackData[0]
//                                                       ["vehicle_type_id"]
//                                                   .toString(),
//                                               "dt_in": dateIn
//                                                   .toString()
...
//           hasInternet = true;
//         });
//         showAlertDialog(context, "LuvPark", "No data found.", () {
//           Navigator.of(context).pop();
//         });
//         return;
//       }
...
//     );
//     // String apiPayKey =
//     //     "${ApiKeys.gApiLuvParkGetResPayKey}?user_id=${jsonDecode(akongP!)['user_id'].toString()}";
//     // print("apiPayKey $apiPayKey");
...
//                 CustomModal(context: context).loader();
//                 HttpRequest(
//                         api: ApiKeys.gApiLuvParkResQueue,
//                         parameters: queueParam)
//                     .post()
//                     .then((queParamData) {
//                   print("queParamData $queParamData");
