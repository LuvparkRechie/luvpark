          ...
          Obx(
            () => Expanded(
              child: Container(
                ...
                child:
                    controller.isLoadDisplay.value
                        ? Center(
                          child: SizedBox(
                            height: 40,
                            width: 40,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  CustomTitle(
                                                    text:
                                                        controller
                                                            .searchedZone[index]["park_area_name"],
                                                    fontSize: 16,
                                                    maxlines: 1,
                                              ...
                                              builder: ((context, constraints) {
                                                ...
                                                if (isPwd == "Y") {
                                                  iconAsset = controller
                                                      .getIconAssetForPwdDetails(
                                                        controller
                                                            .searchedZone[index]["parking_type_code"],
                                                        vehicleTypes,
                                                      );
                                                } else {
                                                  iconAsset = controller
...
class _ParkingDetailsState extends State<ParkingDetails> {
  ...
  void getVhRatesData(String vhType) async {
    ratesWidget = <Widget>[];
    List data =
        widget.dataParam["parkingRatesData"].where((obj) {
          return obj["vehicle_type"].toString().trim().toLowerCase().contains(
            vhType.toString().trim().toLowerCase(),
          );
        }).toList();
            ...
            children: [
              ...
              Expanded(
                child: Container(
                  ...
                  child: Row(
                    children: [
                      Expanded(child: CustomParagraph(text: " ", maxlines: 1)),
                      CustomParagraph(
                        text: " ",
                        color: Colors.black,
                        textAlign: TextAlign.right,
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              CustomTitle(
                                text:
                                    widget
                                        .dataParam["markerData"][0]["park_area_name"]
                                        .toString(),
                                fontSize: 18,
                              ),
                              Container(height: 5),
                              CustomParagraph(
                                text:
                                    widget.dataParam["markerData"][0]["address"]
                                        .toString(),
                                maxlines: 2,
                                overflow: TextOverflow.ellipsis,
                                fontSize: 12,
                        ...
                        LayoutBuilder(
                          builder: ((context, constraints) {
                            final String isPwd =
                                widget.dataParam["markerData"][0]["is_pwd"] ??
                                "N";
                            final String vehicleTypes =
                                widget
                                    .dataParam["markerData"][0]["vehicle_types_list"];
                            String iconAsset;

                            if (isPwd == "Y") {
                              iconAsset = getIconAssetForPwdDetails(
                                widget
                                    .dataParam["markerData"][0]["parking_type_code"],
                                vehicleTypes,
                              );
                            } else {
                              iconAsset = getIconAssetForNonPwdDetails(
                    ...
                    Container(height: 5),
                    Divider(color: AppColor.subtitleColor),
                    Container(height: 5),
                    Row(
                      children: [
                        Expanded(
                          child: Row(
                            children: [
                              ...
                              CustomParagraph(
                                text:
                                    widget
                                        .dataParam["markerData"][0]["time_arrival"],
                                fontWeight: FontWeight.w500,
                                maxlines: 1,
                                fontSize: 12,
                                minFontSize: 10,
                        ...
                        InkWell(
                          onTap: () async {
                            ...
                            String mapUrl = "";
                            String dest =
                                "${widget.dataParam["markerData"][0]["pa_latitude"]},${widget.dataParam["markerData"][0]["pa_longitude"]}";
                            if (Platform.isIOS) {
  ...
  Widget _amenities() {
    return SingleChildScrollView(
      child:
          widget.dataParam["amenitiesData"].isEmpty
              ? CustomParagraph(text: "No amenities")
              : Column(
                children: [
                  for (
                      ...
                      children: [
                        for (int j = i; j < i + 2; j++)
                          j < widget.dataParam["amenitiesData"].length
                              ? _buildColumn(
                                widget
                                    .dataParam["amenitiesData"][j]["parking_amenity_desc"],
                                widget.dataParam["amenitiesData"][j]["icon"],
                              )
                              : _buildPlaceholder(),
                      ],
      ...
      secondChild: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Row(
              mainAxisAlignment:
                  widget.dataParam["vehicleTypes"].length >= 3
                      ? MainAxisAlignment.spaceBetween
                      : MainAxisAlignment.start,
              children: [
                for (
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              CustomParagraph(
                                text:
                                    widget.dataParam["vehicleTypes"][i]["name"],
                                fontSize: 12,
                                fontWeight: FontWeight.w500,
                                color:
                                    denoInd == i
            ...
            Container(height: 20),
            Column(children: [...ratesWidget.toList()]),
          ],
        ),
      ),
      crossFadeState: CrossFadeState.showSecond,
        ...
        child: Row(
          children: [
            ...
            Flexible(
              child: CustomParagraph(
                text:
                    text.toLowerCase().trim().contains("perpendicular")
                        ? text
                            .trim()
                            .replaceAll("PERPENDICULAR", "\nPERPENDICULAR")
                            .trim()
